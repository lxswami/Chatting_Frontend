                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full border border-gray-300 cursor-pointer rounded-lg px-3 py-2 bg-white focus:outline-none transition hover:shadow-md hover:shadow-gray-400"
                                />
